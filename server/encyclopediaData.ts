...
export const ENCYCLOPEDIA_SPECIES: SpeciesEntry[] = [
  {
    ...
    active_season_details: 'Spring to Autumn (Peak activity: Late spring through summer. Seasonal timing varies by region and climate.)',
  ...
  },
  {
    ...
    active_season_details: 'Late spring through autumn; worker foraging and sweet scavenging intensify during late summer.',
  ...
  },
  {
    ...
    legal_protection_status: 'Beneficial pollinator; several rare bumblebee species are protected under regional biodiversity legislation.',
    country_top_ten: [
  ...
  {
    id: 'syrphidae',
    common_name: 'Hoverfly (Flower Fly)',
    latin_name: 'Syrphidae',
    category: 'Useful',
    danger_level: 0,
    can_sting: false,
    can_bite: false,
    ...
    dangerous_to_pets: false,
    pet_child_hazard: 'Low',
    pet_child_explanation: 'Non-venomous pollinator lacking a stinger and venom-delivery apparatus. Hoverflies do not pose a stinging threat to humans or pets.',
    regions: ['UK', 'EU', 'US', 'CA', 'AU'],
    active_seasons: ['Spring', 'Summer', 'Autumn'],
    active_season_details: 'Spring through autumn; most active on warm, sunny days.',
    habitat: 'Gardens, flower beds, meadows, agricultural fields, and woodland borders.',
    description: 'Beneficial true fly that mimics the yellow-and-black warning coloration of wasps and bees (Batesian mimicry). Adults have only two wings, large compound eyes, and short antennae. They are non-venomous and possess no stinger or biting mouthparts.',
    ...
    photo_url: 'https://images.unsplash.com/photo-1558642452-9d2a7deb7f62?auto=format&fit=crop&w=800&q=80',
    look_alikes: ['Common Yellowjacket (Vespula vulgaris)', 'Honeybee (Apis mellifera)', 'Paper Wasp (Polistes)'],
    ...
    conservation_status: 'Least Concern (IUCN)',
    legal_protection_status: 'Beneficial pollinator and natural biocontrol agent. No commercial or legal restrictions.',
    country_top_ten: []
  },
  {
    ...
    dangerous_to_pets: false,
    pet_child_hazard: 'Low',
    pet_child_explanation: 'Harmless to humans and domestic pets. Beneficial predator of aphids.',
    regions: ['UK', 'EU', 'US', 'CA'],
    active_seasons: ['Spring', 'Summer', 'Autumn'],
    active_season_details: 'Spring through autumn; overwinter in sheltered leaf litter or bark crevices.',
    ...
    conservation_status: 'Least Concern (IUCN)',
    legal_protection_status: 'Beneficial agricultural and garden insect.',
    country_top_ten: []
  },
  {
    id: 'vespa-velutina',
    ...
    regions: ['UK', 'EU'],
    active_seasons: ['Spring', 'Summer', 'Autumn'],
    active_season_details: 'Spring through autumn; predation activity peaks in late summer around apiaries.',
  ...
  },
  {
    ...
    active_season_details: 'Summer and autumn; males wander in humid weather after rain searching for mates.',
  ...
  },
  {
    ...
    regions: ['US', 'CA'],
    active_seasons: ['Spring', 'Summer', 'Autumn'],
    active_season_details: 'Active from early spring through late autumn whenever temperatures are above freezing.',
  ...
  },
  {
    ...
    regions: ['UK', 'EU'],
    active_seasons: ['Spring', 'Summer', 'Autumn'],
    active_season_details: 'Active from spring through autumn, especially in humid woodland undergrowth and moorland.',
    ...
    when_to_call_emergency: 'Consult a doctor if an expanding target rash (Erythema migrans), flu-like symptoms, or neurological signs emerge within 3 to 30 days.',
    photo_url: 'https://images.unsplash.com/photo-1596704017254-9b121068fb31?auto=format&fit=crop&w=800&q=80',
    look_alikes: ['Hedgehog Tick (Ixodes hexagonus)', 'Deer Tick (Ixodes scapularis)'],
    fun_fact: 'Castor bean ticks spend over 90% of their multi-year lifecycle in the environment searching for suitable hosts during questing periods.',
    conservation_status: 'Not evaluated',
    legal_protection_status: 'Not protected.',
    country_top_ten: [
  ...
  },
  {
    ...
    regions: ['US', 'CA'],
    active_seasons: ['Spring', 'Summer', 'Autumn'],
    active_season_details: 'Spring through autumn; seeks sheltered microhabitats during cooler periods.',
  ...
  },
  {
    ...
    active_season_details: 'Summer months, peaking on hot, humid, windless days near water or livestock.',
  ...
  },
  {
    ...
    regions: ['US', 'EU', 'AU'],
    active_seasons: ['Summer', 'Autumn'],
    active_season_details: 'Late spring through autumn in warm weather; eggs can overwinter in sheltered microclimates.',
  ...
  },
  {
    ...
    dangerous_to_pets: false,
    pet_child_hazard: 'Low',
    pet_child_explanation: 'Harmless to children and pets. Mandibles cannot pierce human skin effectively.',
    regions: ['UK', 'EU'],
    active_seasons: ['Summer'],
    active_season_details: 'Late spring and early summer (especially warm, balmy June/July evenings).',
  ...
  },
  {
    ...
    regions: ['EU', 'US', 'CA', 'UK'],
    active_seasons: ['Spring', 'Summer', 'Autumn'],
    active_season_details: 'Spring through autumn; nests are founded in early spring.',
