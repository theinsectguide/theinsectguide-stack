...
import { Bug, ArrowRight, Loader2, Sparkles, ShieldCheck, ArrowLeft } from 'lucide-react';
...
export const RegisterPage: React.FC<RegisterPageProps> = ({ onNavigate, onGoBack }) => {
  ...
  return (
    <div className="max-w-md mx-auto px-4 py-6 md:py-12 space-y-4">
      {onGoBack && (
        <div>
          <button
            onClick={onGoBack}
