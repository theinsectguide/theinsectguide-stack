        ...
        {completed && (
          <div className="absolute inset-0 z-50 rounded-3xl bg-[#16162c] p-6 sm:p-8 flex flex-col justify-center items-center text-center space-y-5 animate-in fade-in">
            ...
            <div className="space-y-1">
              <h3 className="text-2xl font-display font-black text-white">Abonnement Confirmé !</h3>
              <p className="text-xs text-slate-300">
                Votre abonnement <strong className="text-emerald-400">$4.99/mois</strong> est activé.
              </p>
            </div>
            <button
