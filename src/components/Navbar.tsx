          ...
          {!isAuthenticated ? (
            <div className="flex items-center gap-1 sm:gap-2">
              ...
              <button
                ...
                className="flex items-center gap-1 sm:gap-1.5 px-2.5 sm:px-3.5 py-1.5 rounded-lg bg-gradient-to-r from-[#2e86ff] to-[#10b981] text-white text-xs sm:text-sm font-semibold shadow-md hover:brightness-110 active:scale-95 transition-all min-h-[38px]"
              >
